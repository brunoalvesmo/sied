...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void imprimir(){
           try{
       JasperReport report = JasperCompileManager.compileReport("C:\\Users\\Carlos\\JaspersoftWorkspace\\MyReports\\RelatorioEscola.jrxml");
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtData, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 120, -1));

        txtUsuario.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        txtUsuario.setText("Usuário");
        jPanel1.add(txtUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 210, 30));
